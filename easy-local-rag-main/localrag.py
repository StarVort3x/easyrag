...
print(NEON_GREEN + "正在解析命令行参数..." + RESET_COLOR)
parser = argparse.ArgumentParser(description="Ollama Chat")
parser.add_argument("--model", default="deepseek-r1:1.5b", help="Ollama model to use (default: deepseek-r1:1.5b)")
...
print(NEON_GREEN + "正在加载和处理知识库..." + RESET_COLOR)
vault_content = []
